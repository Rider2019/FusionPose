...
class HigherResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # raise RuntimeError(y_list[0].shape,y_list[1].shape,y_list[2].shape,y_list[3].shape)
        # x = y_list[1]
        # raise RuntimeError(y_list[1].shape)
        return y_list[3] # 8, 32, 64, 32     8, 64, 32, 16
